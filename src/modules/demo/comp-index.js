...
import demoEdit from './modals/demo-edit.vue';
import demoDetail from './modals/demo-detail.vue';
...
let exportIdx = {
    'demo.modals.demo-edit': demoEdit,
    'demo.modals.demo-detail': demoDetail,
